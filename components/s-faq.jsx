...
const DEFAULT_FAQS = [
  ...
  /* ── Account & Ordering ─────────────────────────────────────────────────────── */
  { id:'dfaq11', question:'Do I need to create an account before ordering?',                   answer:'Yes. You need to create an account and sign in before completing your order. Your account also helps you view your order details and receive relevant updates.',                                                                                                                                                              category:'account',       order:1,  enabled:true, showOnHomepage:false },
  { id:'dfaq12', question:'How can I place an order?',                                         answer:'Browse the products, select the required size or quantity where applicable, add the items to your cart, sign in to your account, enter your delivery information, choose an available payment method, and confirm your order.',                                                                                                category:'account',       order:2,  enabled:true, showOnHomepage:false },
